    ...
    def test_register_user(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({'message': "User was created successfully"}, json.loads(response.data))
    ...
    def test_register_duplicate_user(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({'message': "User with that username already exists"}, json.loads(response.data))
